...
?>
<div class="uk-flex uk-flex-column uk-gap-small">
	<?php foreach ($sections as $section) : ?>
		<h3 class="uk-h4 uk-margin-small-bottom"><?php echo $escape($section->section_title ?? ''); ?></h3>
		<?php if (!empty($section->table_rows)) : ?>
			<table class="uk-table uk-table-divider uk-table-small uk-margin-small-top uk-margin-medium-bottom">
				<thead>
					<tr>
